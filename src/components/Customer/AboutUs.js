                    ...
                    <Grid item xs={12} sm={4}>
                        <Card className={classes.card}>
                            <CardContent className={classes.cardContent}>
                                ...
                                <Typography variant="body2" color="textSecondary" style={{ fontSize: 16, fontWeight: 'bold', height: 170, }}>
                                    Our vision at Cake Caravan is to redefine the art of pastry-making, inspiring joy and delight with every creation. We aim to be the epitome of culinary excellence, known for our innovative flavors, meticulous craftsmanship, and unparalleled commitment to customer satisfaction, creating unforgettable moments one bite at a time.
                                </Typography>
                            </CardContent>
                        </Card>
                    </Grid>
                    <Grid item xs={12} sm={4}>
                        <Card className={classes.card}>
                            <CardContent className={classes.cardContent}>
                                ...
                                <Typography variant="body2" color="textSecondary" style={{ fontSize: 16, fontWeight: 'bold', height: 170, }}>
                                    Our mission at Cake Caravan is to delight customers with exquisite handcrafted treats, elevating every occasion with our culinary expertise. We strive to use the finest ingredients, innovate constantly, and provide personalized service, ensuring that every experience with us is a journey of flavor and a celebration of happiness.
                                </Typography>
                            </CardContent>
                        </Card>
                    </Grid>
